...
4. Beskriv skillnaden mellan en producentprodukt (B2B) och en konsumentprodukt (B2C).
...
En komplementtjänst är en sådan tjänst som erbjuds tillsammans med en vara och förbättrar [[Värdeerbjudandet]] av just den varan. Exempelvis kan det vara en försäkring, IT-support och drift.
En ersättningstjänst är en sådan tjänst som ersätter varan helt och hållet. Exempelvis kan det vara uthyrning och leasing av en vara, alltså äger kunden inte varan.
...
Vertikal integration i en [[Värdekedja]] är när ett företag köper ett annat företag som ligger bakom eller framför en i värdekedjan medan horisontell integration är när man köper en konkurrent, alltså ett annat företag på samma position i värdekedjan.

18. Vad betyder begreppen:

- Outsourcing
	- När man köper in varor och tjänster som man tidigare utfört själv från andra företag.
- Insourcing
	- När man själv utför tjänster som man tidigare köpt från andra företag eller som kunden vanligen utfört själv.
- Offshoring
	- När man flyttar en verksamhet till ett annat land.
- Reshoring
	- Motsatsen till offshoring, alltså när man hämtar tillbaka en verksamhet som man tidigare flyttat till ett annat land.
...
Innovationsspridningens livscykel består av 5 användarkategorier, de är: Pionjärer, Tidiga accepterare, Tidig majoritet, Sen majoritet och Eftersläntrare. Denna livscykel beskriver hur en ny teknologi sprids på en marknad och när den adopteras av olika typer av människor.
...
Ett exempel på ett teknikskifte som fundamentalt ändrat en bransch är när miniräknare helt slog ut maskinräknare. Ett exempel till på ett sådant skifte är när Apple introducerade iPhone vilket Nokia, som då var störst inom mobilmarknaden, inte kunde hantera.
...
Man kan definera [[Marknadsföring]] som: Alla aktiviteter som bidrar till försäljningen av företagets produkter.
...
Egenskaperna för en [[Företagsmarknad]] är:
...
Man kan säga att en dröjsmålsränta är en straffavgift som leverantören/säljaren betalar till köparen för varje dag en leverans är försenad.
...
14. Redogör för principerna bakom den s.k. stage-gate-modellen.
