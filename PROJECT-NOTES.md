...
Current state: **397 pages render callouts, 2,233 callouts total, 0 pages showing raw card
...
The current baseline is 648 pages, 397 with callouts, 2233 callouts, 183 images, 38241
internal links (44 broken), re-baselined after the HI1031/HI1032 prune (F60) and the cross-course consolidation (F61). It records `_meta` — when it was taken, from which directory, and over how
...
1269 files (576 stubs + 693 pages) where a Windows build holds 693. Both platforms report the same count, now 648 after the F60 prune and F61 consolidation; the 1269/693 split above is the pre-prune F59 measurement.
